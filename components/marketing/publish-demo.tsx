...
export function PublishDemo() {
  ...
  return (
    <motion.section
      ...
      variants={reveal}
      className="bg-[#090B0D] py-32"
    >
      <div className="mx-auto max-w-[1280px] px-6 lg:px-[80px]">
        <h2 className="font-display text-[46px] font-bold leading-[1.05] tracking-[-0.03em] text-white sm:text-[48px]">
          One listing.
          <br />
          Everywhere you sell.
        </h2>
        ...
        <div className="mt-14 overflow-hidden rounded-[16px] border border-[#24282D] bg-[#0E1114]">
          {/* Title bar */}
