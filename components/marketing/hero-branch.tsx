...
export function HeroBranch() {
  ...
  return (
    <section className="bg-[#F7F8FA] pb-12 pt-9 lg:pb-[88px] lg:pt-24">
      <div className="mx-auto grid max-w-[1280px] items-center gap-10 px-6 lg:grid-cols-[520px_1fr] lg:gap-20 lg:px-[80px]">
        {/* Copy column */}
        <div>
          <Eyebrow>The modern way to sell everywhere</Eyebrow>
          <h1 className="mt-6 font-display text-[48px] font-extrabold leading-[0.98] tracking-[-0.035em] text-[#090B0D] lg:text-[80px] lg:leading-[0.97]">
            Post once.
            <br />
            Sell most.
          </h1>
          <p className="mt-6 max-w-[460px] text-[17px] leading-relaxed text-[#68727D] lg:text-[20px]">
        ...
        <div className="relative mx-auto hidden h-[520px] w-full max-w-[640px] lg:block">
          <svg
            viewBox="0 0 640 520"
